...
- [ ] Fill guidelines for wemd-electron
- [ ] Fill guidelines for @wemd/server
- [ ] Fill guidelines for @wemd/web
- [ ] Fill guidelines for @wemd/core
- [ ] Add code examples
...
### Package: wemd-electron (`spec/wemd-electron/`)

- Frontend guidelines: `.trellis/spec/wemd-electron/frontend/`

### Package: @wemd/server (`spec/server/`)

- Backend guidelines: `.trellis/spec/server/backend/`

- Frontend guidelines: `.trellis/spec/server/frontend/`

### Package: @wemd/web (`spec/web/`)

- Frontend guidelines: `.trellis/spec/web/frontend/`

### Package: @wemd/core (`spec/core/`)
